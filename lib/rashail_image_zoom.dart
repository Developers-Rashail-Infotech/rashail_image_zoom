...
@immutable
class RashailImageZoom extends StatefulWidget {
  RashailImageZoom({
  ...
  static Vector3 getNearestPointInside(Vector3 point, Quad quad) {
    ...
    final List<Vector3> closestPoints = <Vector3>[
      RashailImageZoom.getNearestPointOnLine(point, quad.point0, quad.point1),
      RashailImageZoom.getNearestPointOnLine(point, quad.point1, quad.point2),
      RashailImageZoom.getNearestPointOnLine(point, quad.point2, quad.point3),
      RashailImageZoom.getNearestPointOnLine(point, quad.point3, quad.point0),
    ];
  ...
  @override
  State<RashailImageZoom> createState() => _ZoomState();
}

class _ZoomState extends State<RashailImageZoom> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(RashailImageZoom oldWidget) {
...
Quad _getAxisAlignedBoundingBoxWithRotation(Rect rect, double rotation) {
  ...
  return RashailImageZoom.getAxisAlignedBoundingBox(boundariesRotated);
}
...
Offset _exceedsBy(Quad boundary, Quad viewport) {
  ...
  for (final Vector3 point in viewportPoints) {
    final Vector3 pointInside =
        RashailImageZoom.getNearestPointInside(point, boundary);
